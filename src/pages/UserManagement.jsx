  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="p-8">
        ...
        {showForm && (
          <form onSubmit={handleCreate} className="bg-white dark:bg-gray-800 p-6 rounded-lg mb-6 space-y-4 shadow">
            <div>
                      ...
                      <>
                        <td className="px-4 py-2">
                          <input
                            ...
                            className="w-full px-2 py-1 rounded bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white text-xs border border-gray-300 dark:border-gray-600"
                          />
                        </td>
