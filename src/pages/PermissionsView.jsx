    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="p-8">
        ...
        {loading ? (
          ...
          <div className="hidden md:block bg-white dark:bg-gray-800 shadow dark:shadow-none rounded-lg overflow-x-auto">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-1">
                        {p.allowedRoles.map((r) => (
                          <span
                            key={r}
                            className="bg-blue-500/20 text-blue-600 dark:text-blue-400 text-xs px-2 py-0.5 rounded"
                          >
                            {r.replace('_', ' ')}
                          </span>
                        ))}
        ...
        <div className="md:hidden space-y-3">
          ...
          {permissions.map((p) => (
            ...
            >
              <p className="text-gray-900 dark:text-white font-mono text-xs mb-1">
                {p.key}
              </p>
