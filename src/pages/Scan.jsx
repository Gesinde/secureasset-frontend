...
function Scan() {
  ...
  const handleAction = async (action) => {
    try {
      ...
      setActionMessage(
        err.response?.data?.message || 'Failed to record action.'
      );
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="p-8 max-w-lg mx-auto">
        ...
        {canAudit && !sessionLoading && (
          <div className="bg-white dark:bg-gray-800 shadow dark:shadow-none p-4 rounded-lg mb-6">
        ...
        {scanning && (
          ...
          <div className="bg-white dark:bg-gray-800 shadow dark:shadow-none p-4 rounded-lg">
            ...
            >
              ...
              <input
                ...
                className="flex-1 px-3 py-2 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm border border-gray-300 dark:border-gray-600 focus:outline-none focus:border-blue-500"
              />
        ...
        {error && (
          ...
          <div className="bg-red-500/10 border border-red-500 text-red-600 dark:text-red-400 text-sm p-3 rounded mt-4">
            {error}
          </div>
        ...
        {asset && (
          ...
          <div className="bg-white dark:bg-gray-800 shadow dark:shadow-none p-6 rounded-lg mt-4">


            {isCached && (

              <div className="bg-yellow-500/10 border border-yellow-500 text-yellow-600 dark:text-yellow-400 text-xs p-2 rounded mb-4">
            ...
            {allowedActions.length > 0 && !isCached && (
              ...
              <>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs border border-gray-300 dark:border-gray-600 focus:outline-none focus:border-blue-500 mb-2"
                />
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  ...
                  {allowedActions.map((action) => (
                    ...
                    <button
                      ...
                      className="text-xs bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white px-3 py-2 rounded"
                    >
