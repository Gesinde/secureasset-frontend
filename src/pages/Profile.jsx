    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="p-8 max-w-lg mx-auto">
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-6">
          <h2 className="text-gray-300 text-sm font-semibold mb-4">Account Information</h2>
          <dl className="space-y-2 text-sm">
            ...
            <div className="flex justify-between border-b border-gray-700 pb-2">
              ...
              <dd className="text-white">{user?.role?.replace('_', ' ')}</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-gray-400">Department</dt>
              <dd className="text-white">{user?.department}</dd>
            </div>
          </dl>
        </div>

        <div className="bg-gray-800 rounded-lg p-6">
          <h2 className="text-gray-300 text-sm font-semibold mb-4">Change Password</h2>

          {message && (
            <div className="bg-green-500/10 border border-green-500 text-green-400 text-sm p-3 rounded mb-4">
              {message}
            </div>
          )}
          {error && (
