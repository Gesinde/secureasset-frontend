...
function Security() {
  ...
  const statusColor = {
    open: 'bg-red-500/20 text-red-600 dark:text-red-400',
    investigating: 'bg-yellow-500/20 text-yellow-600 dark:text-yellow-400',
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            ...
            {incidents.map((incident) => (
              ...
              <div
                key={incident._id}
                className="bg-white dark:bg-gray-800 shadow dark:shadow-none rounded-lg p-4"
              >
                ...
                <div className="flex justify-between items-start">
                  ...
                  <span
                    className={`px-2 py-1 rounded text-xs whitespace-nowrap ${statusColor[incident.status]}`}
                  >
                    {incident.status}
                  </span>
                ...
                {canUpdate && incident.status !== 'resolved' && (
                  ...
                  <div className="mt-3 flex gap-2">
                    ...
                    {incident.status === 'open' && (
                      ...
                      <button
                        onClick={() =>
                          handleStatusChange(incident._id, 'investigating')
                        }
                    ...
                    {incident.status === 'investigating' && (
                      ...
                      <button
                        onClick={() =>
                          handleStatusChange(incident._id, 'resolved')
                        }
