  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
        <p className="text-gray-500 dark:text-gray-400">Verifying asset...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg max-w-md w-full">
        <div className="text-center mb-6">
          <div className="text-green-500 dark:text-green-400 text-5xl mb-2">✓</div>
          <h1 className="text-lg font-semibold text-gray-600 dark:text-gray-300">Verified Asset</h1>
        </div>

        <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-4">{asset.name}</h2>
        ...
        {user && (
          <Link
            to={`/assets/${asset._id}`}
            className="block text-center mt-6 text-blue-600 dark:text-blue-400 hover:underline text-sm"
          >
        ...
        <Link
          to={`/public/asset/${id}`}
          className="block text-center mt-2 text-gray-500 dark:text-gray-500 hover:underline text-xs"
        >
